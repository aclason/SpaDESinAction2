...
# install.packages("devtools") #only needs to be run once
# devtools::install_github("PredictiveEcology/reproducible", ref = "development", dependencies = TRUE)
reproducible::Require(packages = "tati-micheletti/usefun", install_githubArgs = list(ref = "master"))
...
#  LCC05 = vegetationMap, # If you have no internet, you can supply this object ()
